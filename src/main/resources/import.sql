...
INSERT INTO cartao(numero, nome_dono, codigo_seg, senha, ativo, conta_id, taxa_id) VALUES ( '0000000000000001', 'RODRIGO P A SANTOS', 185, '123456', true, 1, 1);
INSERT INTO cartao_debito(limite_diario, cartao_id) VALUES ( 500.00, 1);

INSERT INTO cartao(numero, nome_dono, codigo_seg, senha, ativo, conta_id, taxa_id) VALUES ( '0000000000000002', 'RODRIGO PEREZ A S', 857, '123456', true, 1, 2);
