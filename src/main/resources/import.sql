...
INSERT INTO cartao(nome_dono, codigo_seg, senha, ativo, conta_id, taxa_id) VALUES ( 'RODRIGO P A SANTOS', 185, '123456', true, 1, 1);
INSERT INTO cartao_debito(limite_diario, cartao_id) VALUES ( 500.00, 1)

INSERT INTO cartao(nome_dono, codigo_seg, senha, ativo, conta_id, taxa_id) VALUES ( 'RODRIGO PEREZ A S', 857, '123456', true, 1, 2);
INSERT INTO cartao_credito(limite_mensal, cartao_id) VALUES ( 2000.00, 1)